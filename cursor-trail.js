/* =========================================================================
   ...
   ② 호버 깜박임: html 에 .cur-alt 클래스를 빠르게 토글해서
      클릭 가능한 요소 위의 커서가 흰색 ↔ 녹색으로 깜박이게 한다.
      (흰색 규칙은 style.css, 녹색 규칙은 cursor-trail.css)
...
(function () {
  ...
  var TRAIL = {
    ...
    poolSize: 20   // 동시에 존재할 수 있는 잔상의 최대 개수(꼬리 길이 제한)
  };
  var BLINK = {
    enabled: true,
    interval: 130  // 호버 커서 흰↔녹 전환 간격(ms). 작을수록 빠르게 깜박임.
  };
